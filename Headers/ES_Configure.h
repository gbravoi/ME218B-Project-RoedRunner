...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "AccelerometerFSM.h"
// the name of the Init function
#define SERV_1_INIT InitAccelerometerFSM
// the name of the run function
#define SERV_1_RUN RunAccelerometerFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "I2CService.h"
// the name of the Init function
#define SERV_2_INIT InitI2CService
// the name of the run function
#define SERV_2_RUN RunI2CService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "SPUDHSM.h"
// the name of the Init function
#define SERV_3_INIT InitSPUDHSM
// the name of the run function
#define SERV_3_RUN RunSPUDHSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "DriveService.h"
// the name of the Init function
#define SERV_4_INIT InitDriveService
// the name of the run function
#define SERV_4_RUN RunDriveService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "BumperFSM.h"
// the name of the Init function
#define SERV_5_INIT InitBumperFSM
// the name of the run function
#define SERV_5_RUN RunBumperFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "GP_MasterGameHSM.h"
// the name of the Init function
#define SERV_6_INIT InitMasterGameHSM
// the name of the run function
#define SERV_6_RUN RunMasterGameHSM
// How big should this services Queue be?
...
typedef enum
{
  ...
  SPUD_ANSWER,
  STATUS_UPDATE,
  MINER_LOC_UPDATE_OURS,
  MINER_LOC_UPDATE_THEIRS,
  RES_UPDATE_OURS,
  RES_UPDATE_THEIRS,
   EX_PERMIT_UPDATE_OURS,
  EX_PERMIT_UPDATE_THEIRS,
  NEUTRAL_PERMIT_UPDATE,
	ALL_OUR_PERMITS_UPDATE,
	ALL_THEIR_PERMITS_UPDATE,
  SPUD_EOT,
	//GAMEHSM
	COLLISION,
  GO_TO_MINER,
  ...
  ES_LOCK,
  ES_UNLOCK,
  // Navigation ended in Gameplay SM
  NAVIGATION_ENDED,  
  // I2C EV Color Events from Ed
  EV_I2C_NextStep,
  EV_I2C_Wait4Busy,
  EV_I2C_Wait4Time,
  EV_I2C_EOS,
...
#if NUM_DIST_LISTS > 0
#define DIST_LIST0 PostDriveService, PostMasterGameHSM, PostTestHarnessService0
#endif
#if NUM_DIST_LISTS > 1
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4MinerRing, Check4Beacon, Check4FrontBump, Check4RearBump, IsI2C0Finished, ColorChanged,  Check4Data, Check4Tap
...
#define TIMER3_RESP_FUNC PostAccelerometerFSM
#define TIMER4_RESP_FUNC PostBumperFSM
#define TIMER5_RESP_FUNC TIMER_UNUSED
#define TIMER6_RESP_FUNC PostI2CService
#define TIMER7_RESP_FUNC TIMER_UNUSED
#define TIMER8_RESP_FUNC TIMER_UNUSED
#define TIMER9_RESP_FUNC PostMasterGameHSM
#define TIMER10_RESP_FUNC PostMasterGameHSM
#define TIMER11_RESP_FUNC PostMasterGameHSM
#define TIMER12_RESP_FUNC PostSPUDHSM
#define TIMER13_RESP_FUNC PostSPUDHSM
#define TIMER14_RESP_FUNC PostMasterGameHSM
#define TIMER15_RESP_FUNC TIMER_UNUSED//PostTestHarnessService0
...
#define ALIGNING_TIMER 14
#define SPUD_TIMER 13
#define SPUDQuery_TIMER 12
#define REALIGNMENT_TIMER 11
#define I2C_TIMER 6
#define RAMP_TIMER 10
#define GRAB_TIMER 10
#define DEBOUNCE_TIMER 4
#define ACCL_TIMER 3
#define NAVIGATION_TIMER 9
#define WALL_TIMER 9
